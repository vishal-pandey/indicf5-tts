...
# ==========================================
# UBUNTU / DGX ENVIRONMENT SETUP
# ==========================================
# 1. Explicitly set PATH so the script can find conda and CUDA
export PATH="$HOME/miniconda3/bin:$HOME/anaconda3/bin:/usr/local/cuda/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:$PATH"

# 2. Define the project directory (Change this if your project is elsewhere)
PROJECT_DIR="$HOME/indicf5-tts"
cd "$PROJECT_DIR" || { echo "ERROR: Directory $PROJECT_DIR not found. Please update PROJECT_DIR."; exit 1; }
...
echo "========================================="
echo "  Indic TTS API Setup & Start (Ubuntu/DGX)"
echo "  Engines: IndicF5 + Indic Parler TTS"
echo "========================================="

# ==========================================
# Wait for network (Useful if running via systemd at boot)
# ==========================================
